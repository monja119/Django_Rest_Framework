...
models = ['etudiant', 'entreprise', 'emailetudiant', 'emailentreprise', 'picture', 'badge', 'demande',
          'offre', 'historystudent', 'avis', 'alternance', 'forum', 'commentaire', 'password']
...
urlpatterns = [
    ...
    re_path('^get_connected_etudiant/$', EtudiantViewSet.as_view({'get': 'get_connected'}), name='get_connected_user'),
